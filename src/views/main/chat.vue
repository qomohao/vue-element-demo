            ...
            <div class="flex justify-between">
                ...
                <div class="message-list">
                    <div class="search-box">
                        <el-input placeholder="请输入内容" v-model="searchVal" clearable size="mini"
                ...
                <div class="content-box">
                    ...
                    <div class="message-input">
                        ...
                        <div class="message-submit">
                            <el-input type="textarea" autofocus :max-length='1000' placeholder="请输入内容"
                                v-model="chatVal">
                            </el-input>
